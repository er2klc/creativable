...
const fetchPlatforms = async (userId: string) => {
  ...
  try {
    const { data: modules, error: modulesError } = await supabase
      ...
      `)
      .or(`created_by.eq.${userId},elevate_platforms.created_by.eq.${userId},elevate_platforms.id.in.(select platform_id from elevate_team_access eta join team_members tm on tm.team_id = eta.team_id where tm.user_id = '${userId}')`)
