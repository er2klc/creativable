...
export const SidebarMenuSection = ({ 
  ...
  <item.icon
    className="absolute top-1/2 transform -translate-x-[calc(50%-8px)] -translate-y-1/2 h-5 w-5"
  />
  {elevateProgress > 0 && (
    <Badge 
      variant="outline" 
      className="absolute -top-2 -right-2 text-xs min-w-[18px] h-[18px] flex items-center justify-center px-1 bg-[#161616] text-[#F1C232] border-none"
    >
      {elevateProgress}%
    </Badge>
  )}
