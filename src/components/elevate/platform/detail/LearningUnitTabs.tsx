...
export const LearningUnitTabs = ({
  ...
  return (
    <div className="sticky top-[132px] z-[20] bg-white">
      <Tabs 
        value={activeUnit} 
        className="w-full" 
      ...
      >
        <TabsList className="h-auto p-1 flex-wrap w-full justify-start bg-gray-200/50 border-b border-gray-200 overflow-x-auto">
