...
Let's fix the issue with multi-day events not being saved properly in the team calendar. The problem appears to be in the form handling and data persistence.

<lov-code>
We need to modify the TeamEventForm component to properly handle multi-day events:
